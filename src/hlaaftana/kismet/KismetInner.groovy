...
class KismetInner {
	...
	static {
		...
		'=': macro { Block c, Expression... x ->
			if (x.length == 0) throw new UnexpectedSyntaxException('0 arguments for =')
			change(c, x.init(), x.length == 1 ? Kismet.model(null) : x.last().evaluate(c))
		},
